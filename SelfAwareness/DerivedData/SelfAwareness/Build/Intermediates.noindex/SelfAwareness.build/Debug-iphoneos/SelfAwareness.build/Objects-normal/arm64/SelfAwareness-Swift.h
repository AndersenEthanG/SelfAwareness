...
#ifndef SELFAWARENESS_SWIFT_H
#define SELFAWARENESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SelfAwareness",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13SelfAwareness11AppDelegate")
...
@interface Emotion (SWIFT_EXTENSION(SelfAwareness))
@property (nonatomic) int16_t emotionLevel;
@property (nonatomic, copy) NSString * _Nullable emotionName;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified fourthBtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified fifthBtn;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified emotionNameLabel;
...
- (void)textViewDidBeginEditing:(UITextView * _Nonnull)noteTextView;
...
- (IBAction)fourthBtnTap:(id _Nonnull)sender;
- (IBAction)fifthBtnTap:(id _Nonnull)sender;
- (IBAction)saveBtnTap:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC13SelfAwareness20EmotionTableViewCell")
@interface EmotionTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified emotionNoteLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified emotionTimeLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified emotionEmojiLabel;
...
SWIFT_CLASS("_TtC13SelfAwareness21EmotionViewController")
@interface EmotionViewController : UIViewController <WCSessionDelegate>
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified emotionPickerView;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified happyBtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified madBtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified sadBtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified afraidBtn;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)happyBtnTap:(id _Nonnull)sender;
- (IBAction)madBtnTap:(id _Nonnull)sender;
- (IBAction)sadBtnTap:(id _Nonnull)sender;
- (IBAction)afraidBtnTap:(id _Nonnull)sender;
- (void)fetchEmotions;
...
@interface EmotionViewController (SWIFT_EXTENSION(SelfAwareness)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC13SelfAwareness13SceneDelegate")
